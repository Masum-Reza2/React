        ...
        <div>
            <nav className={`bg-${props.mode} text-${props.mode === 'black' ? 'white' : 'black'} font-bold`}>
                <ul className={`h-12 flex space-x-5 items-center`}>
                    ...
                    <li className={` translate-x-10 hover:cursor-pointer hover:-translate-y-[0.13rem] active:translate-y-[0.13rem] shadow-md shadow-${props.mode==='gray-300'? 'red-400' : 'blue-500'}`}> <Link to="#">User-Guide</Link> </li>
